<?php
/**
 * Template Name: Raiders of the Lost Continent
 *
...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		...
		<?php
		  ...
		  $query_args = array(
		    'post_type' => 'post',
		    'category_name' => 'raiders-of-the-lost-continent',
		    'posts_per_page' => 7,
		    'paged' => $paged
		  );
		  		$classes = array(
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>data-wow-offset="70" data-wow-delay=".2s" data-wow-duration=".3">
			...
			<div class="podcast-preview-wrap">
				<div class="podcast-preview-left">	
					...
					<a class="podcast-listen-button" href="<?php the_permalink()?>">Read <i class="fab fa-readme"></i></a>			
				</div>
